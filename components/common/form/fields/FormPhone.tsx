...
const FormPhone = memo(({ field: config }: { field: FormRadioTypes }) => {
    ...
    return (
        <div className={`${config.wrapperClassName} space-y-2`}>
            ...
            <PhoneInput
                className={error ? "border-red-500 placeholder:text-red-500 bg-red-50 dark:bg-[#192F42] rounded-xl" : ""}
                {...field}
                ...
                inputClassName={error ? "border-red-500 placeholder:text-red-500 bg-red-50 dark:bg-[#192F42]" : ""}
