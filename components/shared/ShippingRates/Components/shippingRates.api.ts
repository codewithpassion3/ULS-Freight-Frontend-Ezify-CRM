import type { ShipmentRatesDto, StreamEvent, CarrierResult } from '../shippinRates.types';
...
export class ShipmentApi {
    ...
    private dispatchEvents(events: StreamEvent[], callbacks: StreamCallbacks): void {
