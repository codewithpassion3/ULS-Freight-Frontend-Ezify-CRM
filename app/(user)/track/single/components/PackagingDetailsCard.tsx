      ...
      <CardContent className="p-4 text-sm">
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="space-y-1">
            <div className="flex justify-between"><span className="text-muted-foreground">Packaging Type:</span> <span className="font-medium text-foreground">{lineItems?.type || 'N/A'}</span></div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-foreground flex items-center gap-1">{dimensionalWeight} lbs <Info className="w-3.5 h-3.5 text-primary" /></span>
            </div>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell colSpan={7} className="pt-0 text-muted-foreground font-medium border-t-0 pl-10">
                Description: {quote.description || lineItems?.type || 'N/A'}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
