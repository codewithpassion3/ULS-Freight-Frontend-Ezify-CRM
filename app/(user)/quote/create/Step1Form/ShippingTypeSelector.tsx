...
export const ShippingTypeSelector = ({ shipmentType, setShipmentType, errors }: { shipmentType: ShipmentType, setShipmentType: (type: ShipmentType) => void, errors: FieldErrors<QuoteSchemaTypes> }) => {
    return (
